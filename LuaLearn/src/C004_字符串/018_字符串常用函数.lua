...
print("==========字符串查找==============")
findPos = string.find(str1,"a") --返回第一个符合条件的下标 str1是被搜索的字符串 a 表示搜索关键字 注意：字符串的下标是从1开始的
findPos2 = string.find(str1,"a",5) -- "5" 表示从字符串下标为5的位置开始搜索。
print("findPos:"..findPos)
print("从下标5开始搜索="..findPos2)
print("==========字符串截取=============")
substr1 =string.sub("Hello world",1,3)
print("截取字符串 substr1="..substr1)
substr2 = string.sub("同学门Hello,大家好!",4,9)
print("截取字符串 substr2="..substr2)
print("===========字符串替换=============")
gsubstr1 = string.gsub("Hello World","l","z")
print("字符串替换 gsubstr1="..gsubstr1)
print("============字符串反转================")
